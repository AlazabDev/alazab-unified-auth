...
const translations: Record<Lang, Record<string, string>> = {
  ar: {
    ...
    // AzaBot
    "azabot.title": "az-agent-auth",
    "azabot.subtitle": "وكيل المصادقة الرسمي — متصل الآن",
    "azabot.textTab": "محادثة نصية",
    "azabot.voiceTab": "محادثة صوتية",
    "azabot.welcome": "مرحباً! أنا وكيل المصادقة az-agent-auth",
    "azabot.welcomeSub": "أساعدك في تسجيل الدخول ورموز التحقق واستعادة الوصول فقط",
    "azabot.q1": "أرسل لي رمز تحقق لتسجيل الدخول",
    "azabot.q2": "نسيت كلمة المرور، كيف أستعيد حسابي؟",
    "azabot.q3": "كيف أفعّل التحقق الثنائي؟",
    "azabot.q4": "كيف أدخل إلى أنظمة العزب بحساب واحد؟",
  ...
  en: {
    ...
    // AzaBot
    "azabot.title": "az-agent-auth",
    "azabot.subtitle": "Official authentication agent — online",
    "azabot.textTab": "Text Chat",
    "azabot.voiceTab": "Voice Chat",
    "azabot.welcome": "Hi! I am az-agent-auth",
    "azabot.welcomeSub": "I only help with sign-in, one-time codes and account recovery",
    "azabot.q1": "Send me a sign-in code",
    "azabot.q2": "I forgot my password, how do I recover?",
    "azabot.q3": "How do I enable two-factor authentication?",
    "azabot.q4": "How do I access Alazab systems with one account?",
